...
sourceSets {
    named("main") {
        ...
        java.srcDirs(
            ...
            "../src/main/legacy/mod/pattern/src/main",
            "../src/main/legacy/mod/jaxp/src/main",
            "../src/main/legacy/mod/rng-jaxp/src/main",
            "../src/main/legacy/mod/rng-validate/src/main",
            "../src/main/legacy/mod/nvdl/src/main",
            "../src/main/legacy/mod/schematron/src/main",
            "../src/main/legacy/mod/xerces/src/main",
            "../src/main/legacy/mod/picl/src/main",
            "../src/main/legacy/mod/rng-jarv/src/main",
            "../src/main/legacy/mod/validate/src/main"
        )
    }
}
...
publishing {
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                name.set("jing")
                description.set("RELAX NG validator")
